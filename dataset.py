...
class BiligualDataset(Dataset):
    ...
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq_len) -> None:
        ...
        self.ds = ds #Lưu dataset
        self.tokenizer_src = tokenizer_src #Tokenizer của ngôn ngữ nguồn
        self.tokenizer_tgt = tokenizer_tgt #Tokenizer của ngôn ngữ đích.
        self.src_lang = src_lang #Ngôn ngữ nguồn
        self.tgt_lang = tgt_lang #Ngôn ngữ đích.
        self.seq_len = seq_len #độ dài tối đa của câu
    ...
    def __getitem__(self, index: Any) -> Any:
        ...
        if enc_num_padding_tokens < 0 or dec_num_padding_tokens < 0: #nếu câu quá dài báo lỗi
        ...
        decoder_input = torch.cat(
            [
                ...
                torch.tensor(
                    [self.pad_token_tgt] * dec_num_padding_tokens,
                    dtype=torch.int64
                )
            ]
        )
